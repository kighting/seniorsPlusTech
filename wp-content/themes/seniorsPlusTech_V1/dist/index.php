    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 order-lg-2 col-md-8 order-md-1 col-sm-12 order-sm-1 order-1 story-text">
                ...
                <p>I agreed, and during our meeting also helped her: install Google Chrome, create contact groups, organize browser bookmarks, setup email templates, organize shared files, create folders, sync camera photos in the cloud… Now Josie’s more connected to her family and theater community than ever before, doing things she never knew existed.</p>
                <p>Working together was such an enjoyable and rewarding experience that I wondered: how many other seniors need assistance with their tech, and can I do something to help? This thought has since grown into a small business — Seniors + Tech, providing retirement home seniors with the 1-on-1 technology support they need to stay connected with the rest of us. <span>Schedule an event at your retirement community today!</span></p>
            </div>
        </div>
    </div>
...
<section id="services">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <p>Seniors + Tech provides 1-on-1 tech support events for retirement communities in the greater Seattle area with:</p>
                <ul>
                    <li>Computers</li>
                    <li>Smart phones</li>
                    <li>Email</li>
...
<section id="contact">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
<!--                <p>We're currently partnered with Pacific Regent Bellevue and Sunrise of Bellevue providing monthly Senior+Tech events.</p>-->
                <p>Are you an Activity Director of a retirement community in the greater Seattle area? Do you want to schedule an event or have more questions? Please contact us!</p>
                <div class="contact">
                    ...
                    <div class="contact-text">
                        ...
                        <ul>
                            ...
                            <li><img src="<?php bloginfo('template_url'); ?>/img/ic_email.svg" class="" alt="Email">ryan@seniorsplustech.com</li>
                            <li><img src="<?php bloginfo('template_url'); ?>/img/ic_phone.svg" class="" alt="Phone">425-298-7335</li>
